// Shared Roblox brand marks. `uid` must be unique per RobloxMark instance
// because the SVG mask is referenced by id.
...
export function RobloxWordmark({ className = "" }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 564 115"
      className={className}
