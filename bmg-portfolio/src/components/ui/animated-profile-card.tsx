    ...
    return (
      <Card
        ...
        className={cn(
          ...
          isAccent ? "text-[var(--on-accent-foreground)]" : "bg-ink-card text-bone",
          className
        )}
        {...rest}
      >
        <CardHeader className="p-0">
          <div className={cn(!displayAvatar && "invisible")}>
            <Avatar
              className="h-16 w-16 ring-2 ring-offset-4 ring-offset-ink-card"
          ...
          <CardDescription
            className={cn("pt-6 text-left", !isAccent && "text-bone-dim", descClass)}
        ...
        {socials.length > 0 && (
          <CardFooter className={cn("mt-6 p-0", footerClass)}>
            <div
              className={cn("flex items-center gap-4", !isAccent && "text-bone-dim")}
            ...
            >
              {socials.map((s) => (
                <a
                  ...
                  className={cn(
                    "transition-opacity",
                    isAccent ? "hover:opacity-75" : "hover:text-bone"
                  )}
                >
                  {s.icon}
                </a>
  ...
  (
    {
      ...
      textOnAccent = "#fff",
      mutedOnAccent = "rgba(255,255,255,0.75)",
      className,
      ...rest
    },
    ref
